...
public class PortManager {
    ...
    public static boolean reinitializePort(String port, boolean checkDeviceInProblemState) {
       return portService.reinitializePort(port, checkDeviceInProblemState);
    }
