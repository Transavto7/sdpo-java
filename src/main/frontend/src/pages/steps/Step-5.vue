...
<template>
    <div class="step-5__outer">
        <div class="step-5">
            <h3>Проверка на алкоголь</h3>

            <div class="step-5__items">
                <div class="step-5__item">
                    <span>1</span>
        ...
        <div class="step-buttons">
            ...
            <button @click="$router.push('/step/6')" v-if="this.$store.state.inspection.type_view" class="btn">Продолжить</button>
        </div>
    </div>
</template>